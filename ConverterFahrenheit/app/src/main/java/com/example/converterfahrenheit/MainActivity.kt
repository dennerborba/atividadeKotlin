package com.example.converterfahrenheit
...
import com.example.converterfahrenheit.ui.theme.ConverterFahrenheitTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            ConverterFahrenheitTheme {
